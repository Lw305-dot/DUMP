...
output_dir = Path("/workspaces/DUMP/Employee_Reports20")
trainingid_dir= Path("/workspaces/DUMP/Employee_Reports20/TrainingIDs")
qr_dir = Path("/workspaces/DUMP/Employee_Reports20/QR_Codes")
