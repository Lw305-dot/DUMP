...
output_dir = Path("/workspaces/DUMP/Employee_Reports13")
output_dir.mkdir(exist_ok=True)
qr_dir = Path("/workspaces/DUMP/Employee_Reports13/QR_Codes")
output_dir.mkdir(exist_ok=True)
qr_dir.mkdir(exist_ok=True) 

BASE_URL = "https://drive.google.com/drive/folders/1TfaHhqs2qiCKBtsm8Z20mT-XcY7hehg_?usp=drive_link/"
