...
output_dir = Path("/workspaces/DUMP/Employee_Reports26")
trainingid_dir= Path("/workspaces/DUMP/Employee_Reports26/TrainingIDs")
qr_dir = Path("/workspaces/DUMP/Employee_Reports26/QR_Codes")
