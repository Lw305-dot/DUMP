...
output_dir = Path("/workspaces/DUMP/Employee_Reports7")
qr_dir = Path("/workspaces/DUMP/Employee_Reports7/QR_Codes")
...
for _, emp in employees.iterrows():
    ...
    if "EXAMS" in all_dfs:
        ...
        print(f"\n--- Debug: Exam Data for {emp_name} ({emp_no}) ---")
        print("Metadata columns:", metadata_cols)
        print("Detected exam columns:", all_cols[len(metadata_cols):])
        print("Raw exam row:")
        print(emp_exam_rows)
        i = len(metadata_cols)
