...
output_dir = Path("/workspaces/DUMP/Employee_Reports43")
trainingid_dir= Path("/workspaces/DUMP/Employee_Reports44/TrainingIDs")
qr_dir = Path("/workspaces/DUMP/Employee_Reports44/QR_Codes")
