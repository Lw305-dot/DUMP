...
PHOTO_DIR = Path("/workspaces/DUMP/Generated_Photos1")#directory where the photos are stored, generated by creation_Pending_IDphotos.py
...
output_dir = Path("/workspaces/DUMP/Employee_Reports44")
