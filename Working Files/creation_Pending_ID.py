...
# --- CONFIG ---
EXCEL_PATH = Path("/workspaces/DUMP/Pending employee Profile.xlsx") 
OUTPUT_DIR = Path("Generated_IDs4")        
...
def save_photo_as_pdf(img_bytes, png_path):
    """
    Convert the embedded image bytes to a single-page png with no extra text.
    """
...
def run():
    ...
    for img in images:
        ...
        # 4) Save the photo as a Png named by the ID
        ...
        img_bytes = img._data()
        save_photo_as_pdf(img_bytes, png_path)
